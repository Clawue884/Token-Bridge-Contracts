...
const l2Prov = new ethers.providers.JsonRpcProvider(
  'https://META1.metachain.cash/rpc'
)
...
const main = async () => {
  ...
  // const l1Receipt = await l1Signer.provider.getTransactionReceipt("0xa43f4150ffcb5c7475afeed691ab6e93c2311093794f07896cd42cbd44f86")
