...
const config = {
  ...
  networks: {
    ...
    metachain1: {
      url: 'https://META1.metachain.cash/rpc',
      accounts: process.env['MAINNET_PRIVKEY']
        ? [process.env['MAINNET_PRIVKEY']]
        : [],
    },
    nova: {
      url: 'https://nova.metachain.cash/rpc',
      accounts: process.env['MAINNET_PRIVKEY']
        ? [process.env['MAINNET_PRIVKEY']]
        : [],
    },
    ...
    METARinkeby: {
      url: 'https://rinkeby.metachain.cash/rpc',
      accounts: process.env['DEVNET_PRIVKEY']
        ? [process.env['DEVNET_PRIVKEY']]
        : [],
    },
    ...
    METAGoerliRollup: {
      url: 'https://goerli-rollup.metachain.cash/rpc',
      accounts: process.env['DEVNET_PRIVKEY']
        ? [process.env['DEVNET_PRIVKEY']]
        : [],
    },
    METASepoliaRollup: {
      url: 'https://sepolia-rollup.metachain.cash/rpc',
      accounts: process.env['DEVNET_PRIVKEY']
        ? [process.env['DEVNET_PRIVKEY']]
        : [],
    },
    ...
    customChains: [
      {
        ...
        chainId: 42170,
        urls: {
          apiURL: 'https://api-nova.metachain.cash/api',
          browserURL: 'https://nova.metachain.cash/',
        },
      },
      {
        ...
        chainId: 421613,
        urls: {
          apiURL: 'https://api-goerli.metachain.cash/api',
          browserURL: 'https://goerli.metachain.cash/',
        },
      },
      {
        ...
        chainId: 421614,
        urls: {
          apiURL: 'https://sepolia-explorer.metachain.cash/api?module=contract&action=verify',
          browserURL: 'https://sepolia-explorer.metachain.cash/',
        },
      }
    ],
  },
