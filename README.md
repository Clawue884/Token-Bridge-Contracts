...
All public metachain chains include a [canonical token bridge deployment](https://developer.metachain.cash/useful-addresses#token-bridge).
...
See the [developer documentation](https://developer.metachain.cash/asset-bridging) for more info.
